...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          ...
          <br>
          <img class="gallery-images" src="images3.png" alt="">
        </div>
        <div class="col-lg-4">
          <img class="gallery-images" src="images/4.png" alt="">
          <br>
      ...
      <div class="row">
        ...
        ?>
          <div class="col-lg-4">
            ...
            <a class="div-link" target="blank" href="https://www.bnmit.org/students-life/#">
              <div class="my-card">
        ...
        <div class="carousel-inner row w-10 mxauto" role="listbox">
          ...
          <div class="carousel-item col-md-4 active">
            ...
            <div style="background-color: #31326f; color:white">
              <a class="btn nav-link" target="_blank" href="https://www.bnmit.org/"> <b>Innovative Project League</b><br>
              <p>IPL
                <br>A Magnificent Event For Tech Enthusiasts
                <br>22-25 sept 2021</p></a>
            </div>
          </div>
          <?php
          while ($row = mysqli_fetch_assoc($rs_result)) {
  ...
  <section id="map">
    <div class="container">
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15555.114109800747!2d77.5671377!3d12.9219513!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe9a257cf4383019e!2sBNM%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1642687818804!5m2!1sen!2sin"  width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    </div>
  </section>
